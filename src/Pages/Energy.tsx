            ...
            <div className="stress_box">
              ...
              <ul>
                <li>
                  ...
                  symptoms like headaches, muscle tension, fatigue,
                  irritability, difficulty concentrating, and changes in
                  appetite or sleep patterns.
                </li>
                <li>
                  Notice behavioral changes: Excessive worrying, restlessness,
                  withdrawing from activities, or increased use of substances
                  can indicate stress.
                </li>
                <li>
            ...
            <div className="stress_box">
              ...
              <ul>
                ...
                <li>
                  ...
                  promote relaxation and well-being, such as exercise,
                  meditation, deep breathing exercises, and hobbies you enjoy.
                </li>
                <li>
                  Healthy lifestyle choices: Maintain a balanced diet, get
                  enough sleep, limit caffeine and alcohol intake, and
                ...
                <li>
                  ...
                  for support and guidance. Talking about your stressors can
